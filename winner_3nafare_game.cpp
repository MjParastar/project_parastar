...
#include "ui_winner_3nafare_game.h"
...
winner_3nafare_game::winner_3nafare_game(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::winner_3nafare_game)
{
    ui->setupUi(this);
...
winner_3nafare_game::~winner_3nafare_game()
{
    delete ui;
}
