    ...
    ui(new Ui::bazi3nafare)
{
    ...
    database.setDatabaseName("C:\\Personal\\AdvancedMabani\\ProjectQt\\Database Sqllite\\Player.db") ;
    database.open() ;

    ui->comboBox_Lang_3->addItem("Persian") ;
    ui->comboBox_Lang_3->addItem("English") ;
...
void bazi3nafare::on_comboBox_Lang_3_activated(int index)
{
    switch(index)
    {
    case 0 :
    {
        ...
        ui->pushButton_Eye_3->move(220 , 140) ;
        ui->pushButton_eyeline_3->move(220,140) ;
    ...
    case 1 :
    {
        ...
        ui->pushButton_Eye_3->move(360 , 140) ;
        ui->pushButton_eyeline_3->move(360 , 140) ;
...
void bazi3nafare::on_pushButton_Eye_3_clicked()
{
    ...
    ui->pushButton_Eye_3->hide() ;
    ui->pushButton_eyeline_3->show() ;
}

void bazi3nafare::on_pushButton_eyeline_3_clicked()
{
    if(ui->lineEdit_Password->echoMode() == QLineEdit::Password)
    {
        ui->lineEdit_Password->setEchoMode(QLineEdit::Normal);
    ...
    ui->pushButton_eyeline_3->hide() ;
    ui->pushButton_Eye_3->show() ;
}



QString bazi3nafare::generateRandomString(int length)
{
...
void bazi3nafare::on_pushButton_generate_kapcha_clicked()
{
...
void bazi3nafare::show_3()
{
    QWidget::show();

    bazi3nafare::on_pushButton_generate_kapcha_clicked() ;
}

bool bazi3nafare::isValidPassword(const QString &password , int &y)
{
    if (password.isEmpty())
    {
        y++ ;
...
bool bazi3nafare::isValidEmail(QString email , int &x)
{
...
bool bazi3nafare::isCaptchaValid(QString userCaptcha)
{
...
void bazi3nafare::on_pushButton_Enroll_3_clicked()
{
    int checkarray[6] ;
    for(int i = 0 ; i < 6 ; i++)
    {
    ...
    switch(sum)
    {
        ...
        if(step_3 == 3)
        {
            QMessageBox::information(this, "successful", "ثبت نام کاربر سوم با موفقیت انجام شد" , "شروع بازی");
        }
